...
class DropdownField<T> extends StatelessWidget {
  ...
  Future<void> _handleShowDropdownMenu(BuildContext context) async {
    ...
    final position = RelativeRect.fromLTRB(offset.dx, offset.dy + overlay.size.height, offset.dx, offset.dy);
  ...
  Widget build(BuildContext context) => TextField(
    ...
    decoration: (decoration ?? const InputDecoration())
        ...
        .copyWith(
          suffixIcon: decoration?.suffixIcon ?? IconButton(onPressed: !enableDropdown ? null : () => _handleShowDropdownMenu(context), icon: const Icon(Icons.arrow_drop_down)),
        ),
